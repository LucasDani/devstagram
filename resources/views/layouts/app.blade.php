...
<body class="bg-gray-100">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    <a href="{{ route('post.create') }}"
                        class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded uppercase text-sm font-bold cursor-pointer">
    ...
    <footer class="text-center p-5 text-gray-500 mt-10 font-bold uppercase ">
